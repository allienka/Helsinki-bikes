#stations
createTableHslStations="CREATE OR REPLACE TABLE HSL_STATIONS (STATION_ID int PRIMARY KEY,STATION VARCHAR(100) DEFAULT ''NOT NULL,ADDRESS VARCHAR(100) DEFAULT '' NOT NULL,JOURNEYS_STARTED DOUBLE(10,2) DEFAULT 0,JOURNEYS_ENDED DOUBLE(10,2) DEFAULT 0,AVG_STARTING_JOURNEY_DIST DOUBLE(10,2) DEFAULT 0,TOTAL_STARTING_JOURNEY_DIST DOUBLE(10,2) DEFAULT 0,AVG_ENDING_JOURNEY_DIST DOUBLE(10,2) DEFAULT 0,TOTAL_ENDING_JOURNEY_DIST DOUBLE(10,2) DEFAULT 0,LAST_PROCESSED_TM timestamp DEFAULT '2021-01-01 00:00:00');"
